...
<head>
    ...
    <title>Login Page - Analisis App</title>
</head>
...
<body class="bg-login">
                ...
                <div class="row row-cols-1 row-cols-lg-2 row-cols-xl-3">
                    <div class="col mx-auto">
                        <div class="mb-4 text-center">
                            <!-- <img src="<?= base_url('temp/') ?>assets/images/logo-img.png" width="180" alt="" /> -->
                        </div>
                        <div class="card">
                            <div class="card-body">
                                <div class="border p-4 rounded">
                                    ...
                                    <div class="login-separater text-center mb-2"> <span>OR SIGN IN WITH EMAIL</span>
                                        <hr />
                                    </div>
                                    <div class="form-body">
                                        <form class="row g-3" method="post" action="<?= base_url('login/masuk') ?>">
                                            <div class="col-12">
                                                ...
                                                <input type="text" class="form-control" id="inputEmailAddress" placeholder="Enter Username" name="username">
                                            </div>
                                            <div class="col-12">
    ...
    <!--end wrapper-->
    <!-- Bootstrap JS -->
    <script src="<?= base_url('temp/') ?>assets/js/bootstrap.bundle.min.js"></script>
    <!--plugins-->
    <script src="<?= base_url('temp/') ?>assets/js/jquery.min.js"></script>
    <script src="<?= base_url('temp/') ?>assets/plugins/simplebar/js/simplebar.min.js"></script>
